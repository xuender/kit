...
func Append2[K, V any](items ...types.Tuple[K, V]) Step2[K, V] {
...
func CenteredMovingAvg[V types.Number](size int) Step[V] {
	return Step[V]{func(input iter.Seq[V]) iter.Seq[V] {
...
func MovingAvg[V types.Number](size int) Step[V] {
	return Step[V]{func(input iter.Seq[V]) iter.Seq[V] {
...
func Prepend2[K, V any](items ...types.Tuple[K, V]) Step2[K, V] {
	return Step2[K, V]{func(input iter.Seq2[K, V]) iter.Seq2[K, V] {
...
//
// It returns a `Step2` function that sorts the sequence.
func SortFunc2[K, V any](cmp func(types.Tuple[K, V], types.Tuple[K, V]) int) Step2[K, V] {
	return Step2[K, V]{func(input iter.Seq2[K, V]) iter.Seq2[K, V] {
...
//
// It returns a `Step2` function that sorts the sequence.
func SortStableFunc2[K, V any](cmp func(types.Tuple[K, V], types.Tuple[K, V]) int) Step2[K, V] {
	return Step2[K, V]{func(input iter.Seq2[K, V]) iter.Seq2[K, V] {
