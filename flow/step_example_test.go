...
import (
	...
	"github.com/xuender/kit/v2/flow"
...
func ExampleDistinct2() {
	fmt.Println(seq.Count2(flow.Chain2(
		seq.Range2(3),
		flow.Append2(types.T(2, 7), types.T(8, 4)),
...
func ExampleSortFunc2() {
	fmt.Println(seq.First2(flow.Chain2(
		seq.Range2(100),
		flow.SortFunc2(func(num1, num2 types.Tuple[int, int]) int {
...
func ExampleSortStableFunc2() {
	fmt.Println(seq.First2(flow.Chain2(
		seq.Range2(100),
		flow.SortStableFunc2(func(num1, num2 types.Tuple[int, int]) int {
			return num2.K - num1.K
		}),
	)))
...
func ExampleConcat2() {
	for key, val := range flow.Chain2(
		seq.Range2(3),
		flow.Concat2(seq.Seq2(types.T(7, 70), types.T(8, 80))),
	) {
		fmt.Println(key, val)
	}
