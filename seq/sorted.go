...
//
// It returns a new sorted sequence.
func SortedFunc2[K, V any](input iter.Seq2[K, V], cmp func(types.Tuple[K, V], types.Tuple[K, V]) int) iter.Seq2[K, V] {
	return func(yield func(K, V) bool) {
		slice := types.Tuples(input)
...
//
// It returns a new sorted sequence.
func SortedStableFunc2[K, V any](
	input iter.Seq2[K, V],
	cmp func(types.Tuple[K, V], types.Tuple[K, V],
	) int,
) iter.Seq2[K, V] {
	return func(yield func(K, V) bool) {
		slice := types.Tuples(input)
